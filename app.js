...
const API = 'http://127.0.0.1:8000';
        ...
        function personelFiltrePanelDoldur() {
            ...
            let gHtml = `<div class="personel-filtre-item personel-filtre-toplu" onclick="personelFiltreTopluUygula('gorev')">🔄 Listedekilerin Hepsini Ekle/Çıkar</div>`;
            ...
            let bHtml = `<div class="personel-filtre-item personel-filtre-toplu" onclick="personelFiltreTopluUygula('brans')">🔄 Listedekilerin Hepsini Ekle/Çıkar</div>`;
        ...
        // --- 🧠 GELİŞMİŞ AKILLI EŞLEŞTİRME MOTORU ---
        ...
        function personelCikarListesiDoldur() {
            ...
            if(kutu.innerHTML === '') kutu.innerHTML = '<div style="padding:15px; text-align:center; color:var(--fg-sub); font-size:11px;">Personel bulunamadı.</div>';
        }
