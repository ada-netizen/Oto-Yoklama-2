...
class TestDevamsizlikMatematigi(unittest.TestCase):
    
    def test_haftasonu_haric_hesaplama(self):
        """Hafta sonuna denk gelen devamsızlıkların genel toplamdan düşülüp düşülmediğini test eder."""
        
        # Senaryo: 852 numaralı öğrenci için karmaşık devamsızlıklar yüklüyoruz
        ...
        # Fonksiyonu çalıştırıp arka plandaki net toplamı istiyoruz
        ...
        # Eğer hesaplanan değerler beklentimizle eşleşmezse test hata verecek (FAILED)
        self.assertEqual(ozsz_net, 2.5, f"HATA! Özürsüz hesaplaması bozuk. Beklenen: 2.5, Sistemdeki: {ozsz_net}")
        self.assertEqual(ozrl_net, 0.0, f"HATA! Hafta sonu filtresi bozulmuş. Beklenen: 0.0, Sistemdeki: {ozrl_net}")

    def test_gec_kalma_hesaplamasi(self):
        ...
        self.assertEqual(ozsz_net, 0.5, "HATA! 5 adet Geç (G) kaydı 0.5 gün Özürsüz yapmalıdır!")

if __name__ == '__main__':
    print("Oto-Yoklama Kalite Kontrol Test Motoru Başlatılıyor...\n" + "="*50)
